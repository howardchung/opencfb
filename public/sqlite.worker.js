    ...
    return (() => {
      var __webpack_modules__ = {
        ...
        794: (e, t) => {
          ...
          class r {
            constructor(e) {
              this.serverChecked = !1, this.chunks = [], this.totalFetchedBytes = 0, this.totalRequests = 0, this.readPages = [], this.readHeads = [], this.lastGet = -1, this._chunkSize = e.requestChunkSize, this.maxSpeed = Math.round((e.maxReadSpeed || 5242880) / this._chunkSize), this.maxReadHeads = e.maxReadHeads ?? 3, this.rangeMapper = e.rangeMapper, this.logPageReads = e.logPageReads ?? !1, e.fileLength && (this._length = e.fileLength);
            }
            ...
            checkServer() {
              ...
              if (i && console.warn(`Warning: The server responded with ${o} encoding to a HEAD request. Ignoring since it may not do so for Range HTTP requests, but this will lead to incorrect results otherwise since the ranges will be based on the compressed data instead of the uncompressed data.`), i && (r = null), !this._length) {
            ...
            doXHR(e, t) {
              if (console.log(`[xhr of size ${(t + 1 - e) / 1024} KiB @ ${e / 1024} KiB]`), this.totalFetchedBytes += t - e, this.totalRequests++, e > t) throw new Error("invalid range (" + e + ", " + t + ") or no bytes requested!");
          ...
          const mod = {
            ...
            async SplitFileHttpDatabase(e, t, r) {
              ...
              for (const {
                ...
                let a;
                console.log("constructing url database", i), a = "chunked" == e.serverMode ? (t, r) => {
              ...
              return this.db.lazyFiles = o, this.db.create_vtab(vtab_1.SeriesVtab), this.db.query = function () {
        ...
        457: (e, t) => {
          ...
          t.SeriesVtab = class {
            ...
            xFilter(e, t, o, s, a) {
              ...
              return console.log("used columns", f), l.elements = i({
                type: "select",
                selector: u,
                columns: f
              }), 0;
            ...
            return n || (n = new Promise(function (n, o) {
              ...
              i.onAbort = function (e) {
                ...
                var e = Ne(4),
                    ...
                    D = t("sqlite3_column_name", "string", ["number", "number"]),
                    M = t("sqlite3_reset", "number", ["number"]),
                    A = t("sqlite3_clear_bindings", "number", ["number"]),
                    R = t("sqlite3_finalize", "number", ["number"]),
                    z = t("sqlite3_create_module_v2", "number", ["number", "string", "number", "number", "number"]),
                    j = t("sqlite3_create_function_v2", "number", ["number", "string", "number", "number", "number", "number", "number", "number", "number"]),
                    ...
                    U = t("sqlite3_result_double", "", ["number", "number"]),
                    W = t("sqlite3_result_null", "", ["number"]),
                    K = t("sqlite3_result_text", "", ["number", "string", "number", "number"]),
                    Y = t("sqlite3_result_blob", "", ["number", "number", "number", "number"]),
                    Q = t("sqlite3_result_int", "", ["number", "number"]),
                    J = t("sqlite3_result_error", "", ["number", "string", "number"]),
                    Z = t("sqlite3_malloc", "number", ["number"]);
  
                i.sqlite3_malloc = Z;
                var ee = t("RegisterExtensionFunctions", "number", ["number"]);
                ...
                function re(e, t) {
                  this.db = t;
                  var r = $(e) + 1;
                  if (this.sqlPtr = ze(r), null === this.sqlPtr) throw new Error("Unable to allocate memory for the SQL string");
                  G(e, this.sqlPtr, r), this.nextSqlPtr = this.sqlPtr, this.nextSqlString = null, this.activeStatement = null;
                }
  
                function ne(t) {
                  this.filename = "dbfile_" + (4294967295 * Math.random() >>> 0), null != t && Ee.createDataFile("/", this.filename, t, !0, !0);
                  const n = r(this.filename, e);
                  this.db = P(e, "i32"), this.handleError(n), ee(this.db), this.statements = {}, this.functions = {};
                }
                ...
                te.prototype.bind = function (e) {
                ...
                }, te.prototype.bind_ = te.prototype.bind, te.prototype.step = function () {
                  if (!this.stmt) throw "Statement closed";
                  this.pos = 1;
                  ...
                  for (var t = k(this.stmt, e), r = E(this.stmt, e), n = new Uint8Array(t), o = 0; o < t; o += 1) n[o] = O[r + o];
  
                  return n;
                }, te.prototype.get = function (e) {
                  null != e && this.bind(e) && this.step();
  
                  for (var t = [], r = y(this.stmt), n = 0; n < r; n += 1) switch (S(this.stmt, n)) {
                    case 1:
                    case 2:
                  ...
                  for (var e = [], t = v(this.stmt), r = 0; r < t; r += 1) e.push(D(this.stmt, r));
                  ...
                  return this.freemem(), 0 === A(this.stmt) && 0 === M(this.stmt);
                }, te.prototype.freemem = function () {
                  for (var e; void 0 !== (e = this.allocatedmem.pop());) Te(e);
                }, te.prototype.free = function () {
                  var e;
                  return this.freemem(), e = 0 === R(this.stmt), delete this.db.statements[this.stmt], this.stmt = 0, e;
                  ...
                  try {
                    this.db.handleError(c(this.db.db, this.nextSqlPtr, -1, e, r)), this.nextSqlPtr = P(r, "i32");
                    var n = P(e, "i32");
                    return 0 === n ? (this.finalize(), {
                      done: !0
                    }) : (this.activeStatement = new te(n, this.db), this.db.statements[n] = this.activeStatement, {
                      value: this.activeStatement,
                      done: !1
                    });
                  } catch (e) {
                    throw this.nextSqlString = V(this.nextSqlPtr), this.finalize(), e;
                  } finally {
                    Le(t);
                  }
                  ...
                  return null !== this.nextSqlString ? this.nextSqlString : V(this.nextSqlPtr);
                }, "function" == typeof Symbol && "symbol" == typeof Symbol.iterator && (re.prototype[Symbol.iterator] = function () {
                  return this;
                  ...
                  try {
                    for (var u = (o = $(n = t) + 1, i = Ne(o), X(n, O, i, o), i), l = Ne(4), f = []; 0 !== P(u, "i8");) {
                      F(e, 0, "i32"), F(l, 0, "i32"), this.handleError(c(this.db, u, -1, e, l));
                      var d = P(e, "i32");
  
                      if (u = P(l, "i32"), 0 !== d) {
                        var h = null;
  
                        for (a = new te(d, this), null != r && a.bind(r); a.step();) null === h && (h = {
                          columns: a.getColumnNames(),
                          values: []
                        }, f.push(h)), h.values.push(a.get());
                  ...
                  F(e, 0, "i32"), this.handleError(a(this.db, t, -1, e, 0));
                  var n = P(e, "i32");
                  ...
                  Object.values(this.statements).forEach(function (e) {
                    e.free();
                  }), Object.values(this.functions).forEach(q), this.functions = {}, this.handleError(n(this.db));
                  var t = Ee.readFile(this.filename, {
                    encoding: "binary"
                  });
                  return this.handleError(r(this.filename, e)), this.db = P(e, "i32"), t;
                }, ne.prototype.close = function () {
                  null !== this.db && (Object.values(this.statements).forEach(function (e) {
                    e.free();
                  }), Object.values(this.functions).forEach(q), this.functions = {}, this.handleError(n(this.db)), Ee.unlink("/" + this.filename), this.db = null);
                  ...
                  Object.prototype.hasOwnProperty.call(this.functions, e) && (q(this.functions[e]), delete this.functions[e]);
                  ...
                  return this.functions[e] = r, this.handleError(j(this.db, e, t.length, 1, 0, r, 0, 0, 0)), this;
                }, i.extract_value = function (e) {
                  var t = P(e, "i32"),
                      r = B(t);
                  return 1 === r || 2 === r ? I(t) : 3 === r ? N(t) : 4 === r ? function (e) {
                    for (var t = L(e), r = H(e), n = new Uint8Array(t), o = 0; o < t; o += 1) n[o] = O[r + o];
                  ...
                  switch (typeof t) {
                    ...
                    case "object":
                      if (null === t) W(e);else if (null != t.length) {
                        var r = C(t, T);
                        Y(e, r, t.length, -1), Te(r);
                      } else J(e, "Wrong API use : tried to return a value of an unknown type (" + t + ").", -1);
                      break;
  
                    default:
                      console.warn("unknown sqlite result type: ", typeof t, t), W(e);
                  }
                  ...
                  for (const e in r) {
                    ...
                    if (r[e] && t[e]) {
                      const r = t[e].bind(t);
                      i = x(r, Array(1 + r.length).fill("i").join("")), s = "*";
                    }
                ...
                }, i.Database = ne, i.CustomDatabase = oe, i.FS = Ee, oe.prototype = Object.create(ne.prototype);
              };
              var a,
                  u = {};
              ...
              v ? (y = g ? r(101).dirname(y) + "/" : "//", l = function (e, t) {
                return d || (d = r(905)), h || (h = r(101)), e = h.normalize(e), d.readFileSync(e, t ? null : "utf8");
              }, f = function (e) {
                var t = l(e, !0);
                return t.buffer || (t = new Uint8Array(t)), A(t.buffer), t;
              }, c = function (e, t, n) {
                d || (d = r(905)), h || (h = r(101)), e = h.normalize(e), d.readFile(e, function (e, r) {
                  e ? n(e) : t(r.buffer);
                });
              }, process.argv.length > 1 && (m = process.argv[1].replace(/\\/g, "/")), p = process.argv.slice(2), e.exports = i, i.inspect = function () {
                return "[Emscripten Module object]";
              }) : (_ || g) && (g ? y = self.location.href : "undefined" != typeof document && document.currentScript && (y = document.currentScript.src), y = 0 !== y.indexOf("blob:") ? y.substr(0, y.lastIndexOf("/") + 1) : "", l = function (e) {
              ...
              u = null, i.arguments && (p = i.arguments), i.thisProgram && (m = i.thisProgram), i.quit && i.quit;
              var E,
                  k,
                  S = [];
              ...
              function F(e, t, r, n) {
                switch ("*" === (r = r || "i8").charAt(r.length - 1) && (r = "i32"), r) {
                  ...
                  case "i64":
                    te = [t >>> 0, (ee = t, +Math.abs(ee) >= 1 ? ee > 0 ? (0 | Math.min(+Math.floor(ee / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((ee - +(~~ee >>> 0)) / 4294967296) >>> 0 : 0)], N[e >> 2] = te[0], N[e + 4 >> 2] = te[1];
                    break;
              ...
              function R(e) {
                var t = i["_" + e];
                return A(t, "Cannot call unknown function " + e + ", make sure it is exported"), t;
              }
              ...
              function z(e, t, r, n, o) {
                ...
                if (n) for (var l = 0; l < n.length; l++) {
                  var c = i[r[l]];
                  c ? (0 === u && (u = Be()), a[l] = c(n[l])) : a[l] = n[l];
                }
                var f = s.apply(null, a);
                return function (e) {
                  return 0 !== u && Le(u), function (e) {
              ...
              function C(e, t) {
                var r;
                return r = 1 == t ? Ne(e.length) : ze(e.length), e.subarray || e.slice ? B.set(e, r) : B.set(new Uint8Array(e), r), r;
              }
              ...
              function W(e, t, r) {
                ...
                if (o - t > 16 && e.subarray && U) return U.decode(e.subarray(t, o));
              ...
              function Y(e) {
                j = e, i.HEAP8 = O = new Int8Array(e), i.HEAP16 = L = new Int16Array(e), i.HEAP32 = N = new Int32Array(e), i.HEAPU8 = B = new Uint8Array(e), i.HEAPU16 = new Uint16Array(e), i.HEAPU32 = new Uint32Array(e), i.HEAPF32 = H = new Float32Array(e), i.HEAPF64 = I = new Float64Array(e);
              }
              ...
              function le(e) {
                if (ie--, i.monitorRunDependencies && i.monitorRunDependencies(ie), 0 == ie && (null !== se && (clearInterval(se), se = null), ae)) {
                  var t = ae;
                  ae = null, t();
                }
              }
              ...
              function ce(e) {
                throw i.onAbort && i.onAbort(e), w(e += ""), M = !0, e = "abort(" + e + "). Build with -s ASSERTIONS=1 for more info.", new WebAssembly.RuntimeError(e);
              }
              ...
              function pe(e) {
                for (; e.length > 0;) {
                  ...
                  if ("function" != typeof t) {
                    var r = t.func;
                    "number" == typeof r ? void 0 === t.arg ? Q.get(r)() : Q.get(r)(t.arg) : r(void 0 === t.arg ? null : t.arg);
                  } else t(i);
                }
              }
  
              function me() {
                me.called || (me.called = !0, function () {
                  ...
                  N[Oe() >> 2] = 60 * i, N[je() >> 2] = Number(n != o);
                  var a = s(t),
                      u = s(r),
                      l = K(a),
                      c = K(u);
                  o < n ? (N[Ce() >> 2] = l, N[Ce() + 4 >> 2] = c) : (N[Ce() >> 2] = c, N[Ce() + 4 >> 2] = l);
                }());
              }
  
              i.preloadedImages = {}, i.preloadedAudios = {}, fe(J = "sql-wasm.wasm") || (Z = J, J = i.locateFile ? i.locateFile(Z, y) : y + Z);
              var _e = {
                ...
                normalize: function (e) {
                  var t = "/" === e.charAt(0),
                      r = "/" === e.substr(-1);
                  return (e = _e.normalizeArray(e.split("/").filter(function (e) {
                    return !!e;
                ...
                basename: function (e) {
                  ...
                  var t = (e = (e = _e.normalize(e)).replace(/\/$/, "")).lastIndexOf("/");
                ...
                resolve: function () {
                  ...
                  return (t ? "/" : "") + (e = _e.normalizeArray(e.split("/").filter(function (e) {
                    return !!e;
                  }), !t).join("/")) || ".";
                },
                ...
                stream_ops: {
                  ...
                  read: function (e, t, r, n, o) {
                    ...
                    for (var i = 0, s = 0; s < n; s++) {
                      ...
                      if (void 0 === a && 0 === i) throw new Ee.ErrnoError(6);
                      if (null == a) break;
                      i++, t[r + s] = a;
                    }
                ...
                default_tty_ops: {
                  get_char: function (e) {
                    if (!e.input.length) {
                      ...
                      if (v) {
                        ...
                        try {
                          n = d.readSync(process.stdin.fd, r, 0, 256, null);
                        } catch (e) {
                  ...
                  put_char: function (e, t) {
                    null === t || 10 === t ? (b(W(e.output, 0)), e.output = []) : 0 != t && e.output.push(t);
                  },
                  flush: function (e) {
                    e.output && e.output.length > 0 && (b(W(e.output, 0)), e.output = []);
                  }
                },
                default_tty1_ops: {
                  put_char: function (e, t) {
                    null === t || 10 === t ? (w(W(e.output, 0)), e.output = []) : 0 != t && e.output.push(t);
                  },
                  flush: function (e) {
                    e.output && e.output.length > 0 && (w(W(e.output, 0)), e.output = []);
                  }
                }
              };
              ...
              var be,
                ...
                createNode: function (e, t, r, n) {
                  if (Ee.isBlkdev(r) || Ee.isFIFO(r)) throw new Ee.ErrnoError(63);
                  ...
                  return Ee.isDir(o.mode) ? (o.node_ops = we.ops_table.dir.node, o.stream_ops = we.ops_table.dir.stream, o.contents = {}) : Ee.isFile(o.mode) ? (o.node_ops = we.ops_table.file.node, o.stream_ops = we.ops_table.file.stream, o.usedBytes = 0, o.contents = null) : Ee.isLink(o.mode) ? (o.node_ops = we.ops_table.link.node, o.stream_ops = we.ops_table.link.stream) : Ee.isChrdev(o.mode) && (o.node_ops = we.ops_table.chrdev.node, o.stream_ops = we.ops_table.chrdev.stream), o.timestamp = Date.now(), e && (e.contents[t] = o, e.timestamp = o.timestamp), o;
                },
                ...
                node_ops: {
                  getattr: function (e) {
                    var t = {};
                    return t.dev = Ee.isChrdev(e.mode) ? e.id : 1, t.ino = e.id, t.mode = e.mode, t.nlink = 1, t.uid = 0, t.gid = 0, t.rdev = e.rdev, Ee.isDir(e.mode) ? t.size = 4096 : Ee.isFile(e.mode) ? t.size = e.usedBytes : Ee.isLink(e.mode) ? t.size = e.link.length : t.size = 0, t.atime = new Date(e.timestamp), t.mtime = new Date(e.timestamp), t.ctime = new Date(e.timestamp), t.blksize = 4096, t.blocks = Math.ceil(t.size / t.blksize), t;
                  },
                ...
                stream_ops: {
                  ...
                  write: function (e, t, r, n, o, i) {
                    ...
                    if (we.expandFileStorage(s, o + n), s.contents.subarray && t.subarray) s.contents.set(t.subarray(r, r + n), o);else for (var a = 0; a < n; a++) s.contents[o + a] = t[r + a];
                    return s.usedBytes = Math.max(s.usedBytes, o + n), n;
                  },
                  llseek: function (e, t, r) {
                    var n = t;
                    if (1 === r ? n += e.position : 2 === r && Ee.isFile(e.node.mode) && (n += e.node.usedBytes), n < 0) throw new Ee.ErrnoError(28);
                    return n;
                  },
                  ...
                  mmap: function (e, t, r, n, o, i) {
                    ...
                    if (2 & i || u.buffer !== j) {
                      if ((n > 0 || n + r < u.length) && (u = u.subarray ? u.subarray(n, n + r) : Array.prototype.slice.call(u, n, n + r)), a = !0, !(s = ye(r))) throw new Ee.ErrnoError(48);
                      O.set(u, s);
                ...
                lookupPath: function (e, t) {
                  if (t = t || {}, !(e = ge.resolve(Ee.cwd(), e))) return {
                    path: "",
                    node: null
                  };
                  var r = {
                  ...
                  for (var o = _e.normalizeArray(e.split("/").filter(function (e) {
                    return !!e;
                  }), !1), i = Ee.root, s = "/", a = 0; a < o.length; a++) {
                    var u = a === o.length - 1;
                    if (u && t.parent) break;
                    if (i = Ee.lookupNode(i, o[a]), s = _e.join2(s, o[a]), Ee.isMountpoint(i) && (!u || u && t.follow_mount) && (i = i.mounted.root), !u || t.follow) for (var l = 0; Ee.isLink(i.mode);) {
                      var c = Ee.readlink(s);
                      if (s = ge.resolve(_e.dirname(s), c), i = Ee.lookupPath(s, {
                        recurse_count: t.recurse_count
                      }).node, l++ > 40) throw new Ee.ErrnoError(32);
                    }
                  }
                ...
                hashRemoveNode: function (e) {
                  var t = Ee.hashName(e.parent.id, e.name);
                  if (Ee.nameTable[t] === e) Ee.nameTable[t] = e.name_next;else for (var r = Ee.nameTable[t]; r;) {
                    if (r.name_next === e) {
                ...
                lookupNode: function (e, t) {
                  ...
                  for (var n = Ee.hashName(e.id, t), o = Ee.nameTable[n]; o; o = o.name_next) {
                    var i = o.name;
                ...
                nodePermissions: function (e, t) {
                  return Ee.ignorePermissions || (!t.includes("r") || 292 & e.mode) && (!t.includes("w") || 146 & e.mode) && (!t.includes("x") || 73 & e.mode) ? 0 : 2;
                },
                mayLookup: function (e) {
                  return Ee.nodePermissions(e, "x") || (e.node_ops.lookup ? 0 : 2);
                },
                ...
                mayOpen: function (e, t) {
                  return e ? Ee.isLink(e.mode) ? 32 : Ee.isDir(e.mode) && ("r" !== Ee.flagsToPermissionString(t) || 512 & t) ? 31 : Ee.nodePermissions(e, Ee.flagsToPermissionString(t)) : 44;
                },
                MAX_OPEN_FDS: 4096,
                nextfd: function (e, t) {
                  e = e || 0, t = t || Ee.MAX_OPEN_FDS;
  
                  for (var r = e; r <= t; r++) if (!Ee.streams[r]) return r;
                ...
                createStream: function (e, t, r) {
                  Ee.FSStream || (Ee.FSStream = function () {}, Ee.FSStream.prototype = {
                    object: {
                      get: function () {
                        return this.node;
                      },
                ...
                syncfs: function (e, t) {
                  "function" == typeof e && (t = e, e = !1), Ee.syncFSRequests++, Ee.syncFSRequests > 1 && w("warning: " + Ee.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
                ...
                mount: function (e, t, r) {
                  ...
                  if (!o && !i) {
                    var s = Ee.lookupPath(r, {
                      follow_mount: !1
                    });
                    if (r = s.path, n = s.node, Ee.isMountpoint(n)) throw new Ee.ErrnoError(10);
                  ...
                  var a = {
                    ...
                    mounts: []
                      ...
                      u = e.mount(a);
                  return u.mount = a, a.root = u, o ? Ee.root = u : n && (n.mounted = a, n.mount && n.mount.mounts.push(a)), u;
                },
                unmount: function (e) {
                  var t = Ee.lookupPath(e, {
                    follow_mount: !1
                  });
                  if (!Ee.isMountpoint(t.node)) throw new Ee.ErrnoError(28);
                  var r = t.node,
                      n = r.mounted,
                      o = Ee.getMounts(n);
                ...
                create: function (e, t) {
                  return t = void 0 !== t ? t : 438, t &= 4095, t |= 32768, Ee.mknod(e, t, 0);
                },
                mkdir: function (e, t) {
                  return t = void 0 !== t ? t : 511, t &= 1023, t |= 16384, Ee.mknod(e, t, 0);
                },
                ...
                mkdev: function (e, t, r) {
                  return void 0 === r && (r = t, t = 438), t |= 8192, Ee.mknod(e, t, r);
                },
                symlink: function (e, t) {
                  if (!ge.resolve(e)) throw new Ee.ErrnoError(44);
                  var r = Ee.lookupPath(t, {
                    parent: !0
                  }).node;
                ...
                rename: function (e, t) {
                  ...
                  if (r = Ee.lookupPath(e, {
                    parent: !0
                  }).node, n = Ee.lookupPath(t, {
                    parent: !0
                  }).node, !r || !n) throw new Ee.ErrnoError(44);
                  if (r.mount !== n.mount) throw new Ee.ErrnoError(75);
                  var u,
                      l = Ee.lookupNode(r, s),
                      c = ge.relative(e, i);
                  if ("." !== c.charAt(0)) throw new Ee.ErrnoError(28);
                  if ("." !== (c = ge.relative(t, o)).charAt(0)) throw new Ee.ErrnoError(55);
                  ...
                  if (l !== u) {
                    ...
                    if (d = u ? Ee.mayDelete(n, a, f) : Ee.mayCreate(n, a)) throw new Ee.ErrnoError(d);
                    if (!r.node_ops.rename) throw new Ee.ErrnoError(63);
                    if (Ee.isMountpoint(l) || u && Ee.isMountpoint(u)) throw new Ee.ErrnoError(10);
                    if (n !== r && (d = Ee.nodePermissions(r, "w"))) throw new Ee.ErrnoError(d);
  
                    try {
                      Ee.trackingDelegate.willMovePath && Ee.trackingDelegate.willMovePath(e, t);
                    } catch (r) {
                      w("FS.trackingDelegate['willMovePath']('" + e + "', '" + t + "') threw an exception: " + r.message);
                    }
                    ...
                    try {
                      Ee.trackingDelegate.onMovePath && Ee.trackingDelegate.onMovePath(e, t);
                    } catch (r) {
                      w("FS.trackingDelegate['onMovePath']('" + e + "', '" + t + "') threw an exception: " + r.message);
                    }
                  }
                },
                rmdir: function (e) {
                  ...
                  try {
                    ...
                    w("FS.trackingDelegate['willDeletePath']('" + e + "') threw an exception: " + t.message);
                  }
                  ...
                  try {
                    ...
                    w("FS.trackingDelegate['onDeletePath']('" + e + "') threw an exception: " + t.message);
                  }
                },
                readdir: function (e) {
                  var t = Ee.lookupPath(e, {
                ...
                readlink: function (e) {
                  ...
                  return ge.resolve(Ee.getPath(t.parent), t.node_ops.readlink(t));
                },
                stat: function (e, t) {
                  var r = Ee.lookupPath(e, {
                    follow: !t
                  }).node;
                  if (!r) throw new Ee.ErrnoError(44);
                ...
                chmod: function (e, t, r) {
                  var n;
                  if (!(n = "string" == typeof e ? Ee.lookupPath(e, {
                    follow: !r
                  }).node : e).node_ops.setattr) throw new Ee.ErrnoError(63);
                ...
                chown: function (e, t, r, n) {
                  var o;
                  if (!(o = "string" == typeof e ? Ee.lookupPath(e, {
                    follow: !n
                  }).node : e).node_ops.setattr) throw new Ee.ErrnoError(63);
                ...
                truncate: function (e, t) {
                  ...
                  var r;
                  if (!(r = "string" == typeof e ? Ee.lookupPath(e, {
                    follow: !0
                  }).node : e).node_ops.setattr) throw new Ee.ErrnoError(63);
                ...
                ftruncate: function (e, t) {
                  var r = Ee.getStream(e);
                  if (!r) throw new Ee.ErrnoError(8);
                  if (0 == (2097155 & r.flags)) throw new Ee.ErrnoError(28);
                ...
                open: function (e, t, r, n, o) {
                  ...
                  var s;
                  if (r = void 0 === r ? 438 : r, r = 64 & (t = "string" == typeof t ? Ee.modeStringToFlags(t) : t) ? 4095 & r | 32768 : 0, "object" == typeof e) s = e;else {
                    e = _e.normalize(e);
                  ...
                  if (Ee.isChrdev(s.mode) && (t &= -513), 65536 & t && !Ee.isDir(s.mode)) throw new Ee.ErrnoError(54);
                  ...
                  l.stream_ops.open && l.stream_ops.open(l), !i.logReadFiles || 1 & t || (Ee.readFiles || (Ee.readFiles = {}), e in Ee.readFiles || (Ee.readFiles[e] = 1, w("FS.trackingDelegate error on read file: " + e)));
  
                  try {
                    if (Ee.trackingDelegate.onOpenFile) {
                      var c = 0;
                      1 != (2097155 & t) && (c |= Ee.tracking.openFlags.READ), 0 != (2097155 & t) && (c |= Ee.tracking.openFlags.WRITE), Ee.trackingDelegate.onOpenFile(e, c);
                    }
                  } catch (t) {
                    w("FS.trackingDelegate['onOpenFile']('" + e + "', flags) threw an exception: " + t.message);
                  }
                ...
                llseek: function (e, t, r) {
                  ...
                  if (0 != r && 1 != r && 2 != r) throw new Ee.ErrnoError(28);
                ...
                write: function (e, t, r, n, o, i) {
                  ...
                  try {
                    ...
                    w("FS.trackingDelegate['onWriteToFile']('" + e.path + "') threw an exception: " + t.message);
                  }
                ...
                readFile: function (e, t) {
                  ...
                  var r,
                      ...
                      o = Ee.stat(e).size,
                      i = new Uint8Array(o);
                  return Ee.read(n, i, 0, o, 0), "utf8" === t.encoding ? r = W(i, 0) : "binary" === t.encoding && (r = i), Ee.close(n), r;
                },
                ...
                createDefaultDevices: function () {
                  Ee.mkdir("/dev"), Ee.registerDevice(Ee.makedev(1, 3), {
                    read: function () {
                      return 0;
                    },
                    write: function (e, t, r, n, o) {
                  ...
                  }), Ee.mkdev("/dev/null", Ee.makedev(1, 3)), ve.register(Ee.makedev(5, 0), ve.default_tty_ops), ve.register(Ee.makedev(6, 0), ve.default_tty1_ops), Ee.mkdev("/dev/tty", Ee.makedev(5, 0)), Ee.mkdev("/dev/tty1", Ee.makedev(6, 0));
                ...
                createSpecialDirectories: function () {
                  ...
                  Ee.mkdir("/proc/self/fd"), Ee.mount({
                    mount: function () {
                ...
                createStandardStreams: function () {
                  i.stdin ? Ee.createDevice("/dev", "stdin", i.stdin) : Ee.symlink("/dev/tty", "/dev/stdin"), i.stdout ? Ee.createDevice("/dev", "stdout", null, i.stdout) : Ee.symlink("/dev/tty", "/dev/stdout"), i.stderr ? Ee.createDevice("/dev", "stderr", null, i.stderr) : Ee.symlink("/dev/tty1", "/dev/stderr"), Ee.open("/dev/stdin", 0), Ee.open("/dev/stdout", 1), Ee.open("/dev/stderr", 1);
                },
                ensureErrnoError: function () {
                  Ee.ErrnoError || (Ee.ErrnoError = function (e, t) {
                    this.node = t, this.setErrno = function (e) {
                      this.errno = e;
                    }, this.setErrno(e), this.message = "FS error";
                  }, Ee.ErrnoError.prototype = new Error(), Ee.ErrnoError.prototype.constructor = Ee.ErrnoError, [44].forEach(function (e) {
                    Ee.genericErrors[e] = new Ee.ErrnoError(e), Ee.genericErrors[e].stack = "<generic error, no stack>";
                  }));
                },
                staticInit: function () {
                  Ee.ensureErrnoError(), Ee.nameTable = new Array(4096), Ee.mount(we, {}, "/"), Ee.createDefaultDirectories(), Ee.createDefaultDevices(), Ee.createSpecialDirectories(), Ee.filesystems = {
                    MEMFS: we
                  };
                },
                init: function (e, t, r) {
                  Ee.init.initialized = !0, Ee.ensureErrnoError(), i.stdin = e || i.stdin, i.stdout = t || i.stdout, i.stderr = r || i.stderr, Ee.createStandardStreams();
                },
                quit: function () {
                ...
                analyzePath: function (e, t) {
                  ...
                  try {
                    ...
                    r.parentExists = !0, r.parentPath = n.path, r.parentObject = n.node, r.name = _e.basename(e), n = Ee.lookupPath(e, {
                      follow: !t
                ...
                createFile: function (e, t, r, n, o) {
                  var i = _e.join2("string" == typeof e ? e : Ee.getPath(e), t),
                      s = Ee.getMode(n, o);
  
                  return Ee.create(i, s);
                },
                createDataFile: function (e, t, r, n, o, i) {
                  var s = t ? _e.join2("string" == typeof e ? e : Ee.getPath(e), t) : e,
                      a = Ee.getMode(n, o),
                      u = Ee.create(s, a);
                  ...
                  if (r) {
                    ...
                    Ee.chmod(u, 146 | a);
                    var d = Ee.open(u, 577);
                    Ee.write(d, r, 0, r.length, 0, i), Ee.close(d), Ee.chmod(u, a);
                  }
  
                  return u;
                },
                createDevice: function (e, t, r, n) {
                  var o = _e.join2("string" == typeof e ? e : Ee.getPath(e), t),
                      i = Ee.getMode(!!r, !!n);
  
                  Ee.createDevice.major || (Ee.createDevice.major = 64);
                  var s = Ee.makedev(Ee.createDevice.major++, 0);
                  return Ee.registerDevice(s, {
                    open: function (e) {
                      e.seekable = !1;
                    },
                    close: function (e) {
                    ...
                    read: function (e, t, n, o, i) {
                      for (var s = 0, a = 0; a < o; a++) {
                        ...
                        if (void 0 === u && 0 === s) throw new Ee.ErrnoError(6);
                        if (null == u) break;
                        s++, t[n + a] = u;
                      }
                ...
                forceLoadFile: function (e) {
                  ...
                  try {
                    e.contents = Pe(l(e.url), !0), e.usedBytes = e.contents.length;
                  } catch (e) {
                    throw new Ee.ErrnoError(29);
                  }
                },
                createLazyFile: function (e, t, r, n, o) {
                  ...
                  if (i.prototype.get = function (e) {
                    ...
                    a.setDataGetter(function (e) {
                      var t = e * s,
                          o = (e + 1) * s - 1;
                      if (o = Math.min(o, n - 1), void 0 === a.chunks[e] && (a.chunks[e] = function (e, t) {
                        ...
                        if (o.open("GET", r, !1), n !== s && o.setRequestHeader("Range", "bytes=" + e + "-" + t), "undefined" != typeof Uint8Array && (o.responseType = "arraybuffer"), o.overrideMimeType && o.overrideMimeType("text/plain; charset=x-user-defined"), o.send(null), !(o.status >= 200 && o.status < 300 || 304 === o.status)) throw new Error("Couldn't load " + r + ". Status: " + o.status);
                        return void 0 !== o.response ? new Uint8Array(o.response || []) : Pe(o.responseText || "", !0);
                      }(t, o)), void 0 === a.chunks[e]) throw new Error("doXHR failed!");
                      return a.chunks[e];
                    }), !i && n || (s = n = 1, n = this.getter(0).length, s = n, b("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n, this._chunkSize = s, this.lengthKnown = !0;
                  ...
                  return Object.keys(u.stream_ops).forEach(function (e) {
                    ...
                    l[e] = function () {
                      return Ee.forceLoadFile(u), t.apply(null, arguments);
                    };
                ...
                createPreloadedFile: function (e, t, r, n, o, s, a, u, l, f) {
                  Browser.init();
                  var d = t ? ge.resolve(_e.join2(e, t)) : e;
  
                  function h(r) {
                    function c(r) {
                      f && f(), u || Ee.createDataFile(e, t, r, n, o, l), s && s(), le();
                    }
  
                    var h = !1;
                    i.preloadPlugins.forEach(function (e) {
                      h || e.canHandle(d) && (e.handle(r, d, c, function () {
                        a && a(), le();
                      }), h = !0);
                    }), h || c(r);
                  }
  
                  ue(), "string" == typeof r ? function (e, t, r, n) {
                    var o = "al " + e;
                    c(e, function (t) {
                      A(t, 'Loading data file "' + e + '" failed (no arrayBuffer).'), h(new Uint8Array(t)), o && le();
                    }, function (t) {
                ...
                saveFilesToDB: function (e, t, r) {
                  ...
                  o.onupgradeneeded = function () {
                    b("creating db"), o.result.createObjectStore(Ee.DB_STORE_NAME);
                    ...
                    e.forEach(function (e) {
                      var t = i.put(Ee.analyzePath(e).object.contents, e);
                ...
                loadFilesFromDB: function (e, t, r) {
                  ...
                  o.onupgradeneeded = r, o.onsuccess = function () {
                    ...
                    e.forEach(function (e) {
                      var t = s.get(e);
                      t.onsuccess = function () {
                        Ee.analyzePath(e).exists && Ee.unlink(e), Ee.createDataFile(_e.dirname(e), _e.basename(e), t.result, !0, !0, !0), ++a + u == l && c();
                      }, t.onerror = function () {
                        u++, a + u == l && c();
                      };
                    }), i.onerror = r;
                ...
                doStat: function (e, t, r) {
                  try {
                    ...
                    if (e && e.node && _e.normalize(t) !== _e.normalize(Ee.getPath(e.node))) return -54;
                    throw e;
                  }
  
                  return N[r >> 2] = n.dev, N[r + 4 >> 2] = 0, N[r + 8 >> 2] = n.ino, N[r + 12 >> 2] = n.mode, N[r + 16 >> 2] = n.nlink, N[r + 20 >> 2] = n.uid, N[r + 24 >> 2] = n.gid, N[r + 28 >> 2] = n.rdev, N[r + 32 >> 2] = 0, te = [n.size >>> 0, (ee = n.size, +Math.abs(ee) >= 1 ? ee > 0 ? (0 | Math.min(+Math.floor(ee / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((ee - +(~~ee >>> 0)) / 4294967296) >>> 0 : 0)], N[r + 40 >> 2] = te[0], N[r + 44 >> 2] = te[1], N[r + 48 >> 2] = 4096, N[r + 52 >> 2] = n.blocks, N[r + 56 >> 2] = n.atime.getTime() / 1e3 | 0, N[r + 60 >> 2] = 0, N[r + 64 >> 2] = n.mtime.getTime() / 1e3 | 0, N[r + 68 >> 2] = 0, N[r + 72 >> 2] = n.ctime.getTime() / 1e3 | 0, N[r + 76 >> 2] = 0, te = [n.ino >>> 0, (ee = n.ino, +Math.abs(ee) >= 1 ? ee > 0 ? (0 | Math.min(+Math.floor(ee / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((ee - +(~~ee >>> 0)) / 4294967296) >>> 0 : 0)], N[r + 80 >> 2] = te[0], N[r + 84 >> 2] = te[1], 0;
                },
                ...
                doMkdir: function (e, t) {
                  return "/" === (e = _e.normalize(e))[e.length - 1] && (e = e.substr(0, e.length - 1)), Ee.mkdir(e, t, 0), 0;
                },
                ...
                doAccess: function (e, t) {
                  ...
                  var n = "";
                  return 4 & t && (n += "r"), 2 & t && (n += "w"), 1 & t && (n += "x"), n && Ee.nodePermissions(r, n) ? -2 : 0;
                },
              ...
              function qe(e) {
                try {
                  return D.grow(e - j.byteLength + 65535 >>> 16), Y(D.buffer), 1;
                } catch (e) {}
              }
              ...
              var Fe = function (e, t, r, n) {
                e || (e = this), this.parent = e, this.mount = e.mount, this.mounted = null, this.id = Ee.nextInode++, this.name = t, this.mode = r, this.node_ops = {}, this.stream_ops = {}, this.rdev = n;
              };
              ...
              }), Ee.FSNode = Fe, Ee.staticInit();
  
              var Me,
                  Ae = {
                a: function (e, t, r, n) {
                  ce("Assertion failed: " + V(e) + ", at: " + [t ? V(t) : "unknown filename", r, n ? V(n) : "unknown function"]);
                },
                t: function (e, t) {
                  return function (e, t) {
                    me();
                    var r = new Date(1e3 * N[e >> 2]);
                    N[t >> 2] = r.getSeconds(), N[t + 4 >> 2] = r.getMinutes(), N[t + 8 >> 2] = r.getHours(), N[t + 12 >> 2] = r.getDate(), N[t + 16 >> 2] = r.getMonth(), N[t + 20 >> 2] = r.getFullYear() - 1900, N[t + 24 >> 2] = r.getDay();
                    var n = new Date(r.getFullYear(), 0, 1),
                        o = (r.getTime() - n.getTime()) / 864e5 | 0;
                    N[t + 28 >> 2] = o, N[t + 36 >> 2] = -60 * r.getTimezoneOffset();
                ...
                G: function (e, t) {
                  try {
                    ...
                    return void 0 !== Ee && e instanceof Ee.ErrnoError || ce(e), -e.errno;
                  }
                },
                v: function (e, t) {
                  try {
                ...
                b: function (e, t, r) {
                  ...
                  try {
                    ...
                    switch (t) {
                      case 0:
                        return (o = ke.get()) < 0 ? -28 : Ee.open(n.path, n.flags, 0, o).fd;
                  ...
                  try {
                    return function (e, t) {
                      ...
                      if (t === r.len) {
                        ...
                        n && (2 & r.prot && ke.doMsync(e, n, t, r.flags, r.offset), Ee.munmap(n)), ke.mappings[e] = null, r.allocated && Te(r.malloc);
                      }
                ...
                c: function (e) {
                  ...
                  for (var o = 1; o <= 4; o *= 2) {
                    var i = r * (1 + .2 / o);
                    if (i = Math.min(i, e + 100663296), qe(Math.min(n, ((t = Math.max(e, i)) % 65536 > 0 && (t += 65536 - t % 65536), t)))) return !0;
                  }
                ...
                q: function (e, t) {
                  var r = 0;
                  return De().forEach(function (n, o) {
                    var i = t + r;
                    N[e + 4 * o >> 2] = i, function (e, t, r) {
                      for (var n = 0; n < e.length; ++n) O[t++ >> 0] = e.charCodeAt(n);
                ...
                p: function (e, t) {
                  try {
                    var r = ke.getStreamFromFD(e),
                        n = r.tty ? 2 : Ee.isDir(r.mode) ? 3 : Ee.isLink(r.mode) ? 7 : 4;
                    return O[t >> 0] = n, 0;
                  } catch (e) {
                    return void 0 !== Ee && e instanceof Ee.ErrnoError || ce(e), e.errno;
                  }
                ...
                n: function (e, t, r, n, o) {
                  try {
                    var i = ke.getStreamFromFD(e),
                        s = 4294967296 * r + (t >>> 0),
                        a = 9007199254740992;
                    return s <= -a || s >= a ? -61 : (Ee.llseek(i, s, n), te = [i.position >>> 0, (ee = i.position, +Math.abs(ee) >= 1 ? ee > 0 ? (0 | Math.min(+Math.floor(ee / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((ee - +(~~ee >>> 0)) / 4294967296) >>> 0 : 0)], N[o >> 2] = te[0], N[o + 4 >> 2] = te[1], i.getdents && 0 === s && 0 === n && (i.getdents = null), 0);
                  } catch (e) {
                    return void 0 !== Ee && e instanceof Ee.ErrnoError || ce(e), e.errno;
                  }
                },
                ...
                g: function (e) {
                  var t = Date.now();
                  return N[e >> 2] = t / 1e3 | 0, N[e + 4 >> 2] = t % 1e3 * 1e3 | 0, 0;
                },
                K: function (e) {
                ...
                C: function (e, t) {
                  ...
                  return function (e, t) {
                    ...
                    try {
                      ...
                      if (!(e instanceof Ee.ErrnoError)) throw e + " : " + (r = function () {
                        var e = new Error();
                      ...
                      }(), i.extraStackTrace && (r += "\n" + i.extraStackTrace()), r.replace(/\b_Z[\w\d_]+/g, function (e) {
                        return e == e ? e : e + " [" + e + "]";
                      }));
                      return Se(e.errno), -1;
                    }
                ...
                function t(e, t) {
                  var r,
                      n = e.exports;
                  i.asm = n, Y((D = i.asm.L).buffer), Q = i.asm.Fa, r = i.asm.M, ne.unshift(r), le();
                }
                ...
                function n(t) {
                  return function () {
                    if (!k && (_ || g)) {
                      if ("function" == typeof fetch && !de(J)) return fetch(J, {
                    ...
                    w("failed to asynchronously prepare wasm: " + e), ce(e);
                  });
                }
  
                if (ue(), i.instantiateWasm) try {
                  return i.instantiateWasm(e, t);
                } catch (e) {
                  return w("Module.instantiateWasm callback failed with error: " + e), !1;
                }
                k || "function" != typeof WebAssembly.instantiateStreaming || fe(J) || de(J) || "function" != typeof fetch ? n(r) : fetch(J, {
                  credentials: "same-origin"
                }).then(function (t) {
                  return WebAssembly.instantiateStreaming(t, e).then(r, function (e) {
                    return w("wasm streaming compile failed: " + e), w("falling back to ArrayBuffer instantiation"), n(r);
                  });
                });
              }(), i.___wasm_call_ctors = function () {
                return (i.___wasm_call_ctors = i.asm.M).apply(null, arguments);
              }, i._sqlite3_malloc = function () {
                return (i._sqlite3_malloc = i.asm.N).apply(null, arguments);
              }, i._sqlite3_free = function () {
                return (i._sqlite3_free = i.asm.O).apply(null, arguments);
              }, i.___errno_location = function () {
                return (Re = i.___errno_location = i.asm.P).apply(null, arguments);
              }),
                  ze = (i._sqlite3_finalize = function () {
                return (i._sqlite3_finalize = i.asm.Q).apply(null, arguments);
              }, i._sqlite3_reset = function () {
                return (i._sqlite3_reset = i.asm.R).apply(null, arguments);
              }, i._sqlite3_clear_bindings = function () {
                return (i._sqlite3_clear_bindings = i.asm.S).apply(null, arguments);
              }, i._sqlite3_value_blob = function () {
                return (i._sqlite3_value_blob = i.asm.T).apply(null, arguments);
              }, i._sqlite3_value_text = function () {
                return (i._sqlite3_value_text = i.asm.U).apply(null, arguments);
              }, i._sqlite3_value_bytes = function () {
                return (i._sqlite3_value_bytes = i.asm.V).apply(null, arguments);
              }, i._sqlite3_value_double = function () {
                return (i._sqlite3_value_double = i.asm.W).apply(null, arguments);
              }, i._sqlite3_value_int = function () {
                return (i._sqlite3_value_int = i.asm.X).apply(null, arguments);
              }, i._sqlite3_value_type = function () {
                return (i._sqlite3_value_type = i.asm.Y).apply(null, arguments);
              }, i._sqlite3_result_blob = function () {
                return (i._sqlite3_result_blob = i.asm.Z).apply(null, arguments);
              }, i._sqlite3_result_double = function () {
                return (i._sqlite3_result_double = i.asm._).apply(null, arguments);
              }, i._sqlite3_result_error = function () {
                return (i._sqlite3_result_error = i.asm.$).apply(null, arguments);
              }, i._sqlite3_result_int = function () {
                return (i._sqlite3_result_int = i.asm.aa).apply(null, arguments);
              }, i._sqlite3_result_int64 = function () {
                return (i._sqlite3_result_int64 = i.asm.ba).apply(null, arguments);
              }, i._sqlite3_result_null = function () {
                return (i._sqlite3_result_null = i.asm.ca).apply(null, arguments);
              }, i._sqlite3_result_text = function () {
                return (i._sqlite3_result_text = i.asm.da).apply(null, arguments);
              }, i._sqlite3_step = function () {
                return (i._sqlite3_step = i.asm.ea).apply(null, arguments);
              }, i._sqlite3_column_count = function () {
                return (i._sqlite3_column_count = i.asm.fa).apply(null, arguments);
              }, i._sqlite3_data_count = function () {
                return (i._sqlite3_data_count = i.asm.ga).apply(null, arguments);
              }, i._sqlite3_column_blob = function () {
                return (i._sqlite3_column_blob = i.asm.ha).apply(null, arguments);
              }, i._sqlite3_column_bytes = function () {
                return (i._sqlite3_column_bytes = i.asm.ia).apply(null, arguments);
              }, i._sqlite3_column_double = function () {
                return (i._sqlite3_column_double = i.asm.ja).apply(null, arguments);
              }, i._sqlite3_column_text = function () {
                return (i._sqlite3_column_text = i.asm.ka).apply(null, arguments);
              }, i._sqlite3_column_type = function () {
                return (i._sqlite3_column_type = i.asm.la).apply(null, arguments);
              }, i._sqlite3_column_name = function () {
                return (i._sqlite3_column_name = i.asm.ma).apply(null, arguments);
              }, i._sqlite3_bind_blob = function () {
                return (i._sqlite3_bind_blob = i.asm.na).apply(null, arguments);
              }, i._sqlite3_bind_double = function () {
                return (i._sqlite3_bind_double = i.asm.oa).apply(null, arguments);
              }, i._sqlite3_bind_int = function () {
                return (i._sqlite3_bind_int = i.asm.pa).apply(null, arguments);
              }, i._sqlite3_bind_text = function () {
                return (i._sqlite3_bind_text = i.asm.qa).apply(null, arguments);
              }, i._sqlite3_bind_parameter_index = function () {
                return (i._sqlite3_bind_parameter_index = i.asm.ra).apply(null, arguments);
              }, i._sqlite3_sql = function () {
                return (i._sqlite3_sql = i.asm.sa).apply(null, arguments);
                ...
                return (i._sqlite3_errmsg = i.asm.ua).apply(null, arguments);
              }, i._sqlite3_exec = function () {
                return (i._sqlite3_exec = i.asm.va).apply(null, arguments);
              }, i._sqlite3_prepare_v2 = function () {
                return (i._sqlite3_prepare_v2 = i.asm.wa).apply(null, arguments);
              }, i._sqlite3_create_module_v2 = function () {
                return (i._sqlite3_create_module_v2 = i.asm.xa).apply(null, arguments);
              }, i._sqlite3_declare_vtab = function () {
                return (i._sqlite3_declare_vtab = i.asm.ya).apply(null, arguments);
              }, i._sqlite3_changes = function () {
                return (i._sqlite3_changes = i.asm.za).apply(null, arguments);
              }, i._sqlite3_close_v2 = function () {
                return (i._sqlite3_close_v2 = i.asm.Aa).apply(null, arguments);
              }, i._sqlite3_create_function_v2 = function () {
                return (i._sqlite3_create_function_v2 = i.asm.Ba).apply(null, arguments);
              }, i._sqlite3_open = function () {
                return (i._sqlite3_open = i.asm.Ca).apply(null, arguments);
              }, i._malloc = function () {
                return (ze = i._malloc = i.asm.Da).apply(null, arguments);
              }),
                  Te = i._free = function () {
                return (Te = i._free = i.asm.Ea).apply(null, arguments);
              },
                  Ce = (i._RegisterExtensionFunctions = function () {
                return (i._RegisterExtensionFunctions = i.asm.Ga).apply(null, arguments);
              }, i.__get_tzname = function () {
                return (Ce = i.__get_tzname = i.asm.Ha).apply(null, arguments);
              }),
                  je = i.__get_daylight = function () {
                return (je = i.__get_daylight = i.asm.Ia).apply(null, arguments);
              },
                  Oe = i.__get_timezone = function () {
                return (Oe = i.__get_timezone = i.asm.Ja).apply(null, arguments);
              },
                  Be = i.stackSave = function () {
                return (Be = i.stackSave = i.asm.Ka).apply(null, arguments);
              },
                  Le = i.stackRestore = function () {
                return (Le = i.stackRestore = i.asm.La).apply(null, arguments);
              },
                  Ne = i.stackAlloc = function () {
                return (Ne = i.stackAlloc = i.asm.Ma).apply(null, arguments);
              },
                  He = i._memalign = function () {
                return (He = i._memalign = i.asm.Na).apply(null, arguments);
              };
  
              function Ie(e) {
                function t() {
                  Me || (Me = !0, i.calledRun = !0, M || (i.noFSInit || Ee.init.initialized || Ee.init(), Ee.ignorePermissions = !1, ve.init(), pe(ne), i.onRuntimeInitialized && i.onRuntimeInitialized(), function () {
                    if (i.postRun) for ("function" == typeof i.postRun && (i.postRun = [i.postRun]); i.postRun.length;) e = i.postRun.shift(), oe.unshift(e);
                    var e;
                    pe(oe);
                  }()));
                }
                ...
                e = e || p, ie > 0 || (function () {
                  if (i.preRun) for ("function" == typeof i.preRun && (i.preRun = [i.preRun]); i.preRun.length;) e = i.preRun.shift(), re.unshift(e);
                  var e;
                  pe(re);
              ...
              if (i.ccall = z, i.cwrap = function (e, t, r, n) {
                var o = (r = r || []).every(function (e) {
                  return "number" === e;
                });
                return "string" !== t && o && !n ? R(e) : function () {
                  return z(e, t, r, arguments);
                };
              }, i.setValue = F, i.getValue = P, i.UTF8ToString = V, i.stringToUTF8 = G, i.lengthBytesUTF8 = $, i.addFunction = x, i.stackSave = Be, i.stackRestore = Le, i.stackAlloc = Ne, ae = function e() {
                Me || Ie(), Me || (ae = e);
              }, i.run = Ie, i.preInit) for ("function" == typeof i.preInit && (i.preInit = [i.preInit]); i.preInit.length > 0;) i.preInit.pop()();
              return Ie(), i;
            }));
          };

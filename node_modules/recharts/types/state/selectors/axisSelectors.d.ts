...
import { XorYorZType, XorYType } from './selectTooltipAxisType';
...
}, axisType: XorYorZType, axisId: AxisId, isPanorama: boolean) => NumberDomain | undefined) & {
    clearCache: () => void;
    resultsCount: () => number;
    resetResultsCount: () => void;
} & {
    resultFunc: (resultFuncArgs_0: AllStackGroups | undefined, resultFuncArgs_1: ChartDataState, resultFuncArgs_2: any, resultFuncArgs_3: NumberDomain | undefined) => NumberDomain | undefined;
    memoizedResultFunc: ((resultFuncArgs_0: AllStackGroups | undefined, resultFuncArgs_1: ChartDataState, resultFuncArgs_2: any, resultFuncArgs_3: NumberDomain | undefined) => NumberDomain | undefined) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => NumberDomain | undefined;
...
}, axisType: "xAxis" | "yAxis", axisId: AxisId, isPanorama: boolean) => AxisPropsForCartesianGridTicksGeneration | undefined) & {
    clearCache: () => void;
    resultsCount: () => number;
    resetResultsCount: () => void;
} & {
    resultFunc: (resultFuncArgs_0: LayoutType, resultFuncArgs_1: XAxisSettings | YAxisSettings, resultFuncArgs_2: string | undefined, resultFuncArgs_3: RechartsScale | undefined, resultFuncArgs_4: readonly unknown[] | undefined, resultFuncArgs_5: readonly unknown[] | undefined, resultFuncArgs_6: AxisRange | undefined, resultFuncArgs_7: readonly number[] | undefined, resultFuncArgs_8: any) => AxisPropsForCartesianGridTicksGeneration | undefined;
    memoizedResultFunc: ((resultFuncArgs_0: LayoutType, resultFuncArgs_1: XAxisSettings | YAxisSettings, resultFuncArgs_2: string | undefined, resultFuncArgs_3: RechartsScale | undefined, resultFuncArgs_4: readonly unknown[] | undefined, resultFuncArgs_5: readonly unknown[] | undefined, resultFuncArgs_6: AxisRange | undefined, resultFuncArgs_7: readonly number[] | undefined, resultFuncArgs_8: any) => AxisPropsForCartesianGridTicksGeneration | undefined) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => AxisPropsForCartesianGridTicksGeneration | undefined;
...
}, axisType: "zAxis", axisId: AxisId, isPanorama: false) => ZAxisWithScale | undefined) & {
    clearCache: () => void;
    resultsCount: () => number;
    resetResultsCount: () => void;
} & {
    resultFunc: (resultFuncArgs_0: ZAxisSettings, resultFuncArgs_1: RechartsScale | undefined) => ZAxisWithScale | undefined;
    memoizedResultFunc: ((resultFuncArgs_0: ZAxisSettings, resultFuncArgs_1: RechartsScale | undefined) => ZAxisWithScale | undefined) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => ZAxisWithScale | undefined;
